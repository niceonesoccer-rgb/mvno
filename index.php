            ...
            <div class="left-section">
                ...
                <section class="ranking-section">
                    <div class="ranking-list">
                        <a href="/MVNO/mvno/mvno.php" class="ranking-card">
        ...
        <div class="content-layout">
            <section class="phone-deal-carousel-section">
                ...
                <div class="phone-deal-footer">
                    <a href="/MVNO/mno/mno.php?from=home" class="more-btn">
                        <span>자급제폰 더보기 &gt;</span>
                    </a>
                </div>
            </section>
        ...
        <div class="content-layout">
            <section class="exclusive-plan-section">
                ...
                <div class="section-footer">
                    <a href="/MVNO/mvno/mvno.php?mobilePlanOperatorIdList=14&sorting=recommend_v2&page=0&from=home" class="more-btn">
