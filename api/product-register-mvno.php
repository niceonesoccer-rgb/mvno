...
$productData = [
    ...
    'contract_period_unit' => $_POST['contract_period_unit'] ?? '일',
    'discount_period' => $_POST['discount_period'] ?? '',
    'discount_period_value' => $_POST['discount_period_value'] ?? '',
    'discount_period_unit' => $_POST['discount_period_unit'] ?? '월',
    'price_main' => !empty($_POST['price_main']) ? intval(str_replace(',', '', $_POST['price_main'])) : 0,
    'price_after' => ($_POST['price_after_type_hidden'] ?? '') === 'free' ? null : (isset($_POST['price_after']) && $_POST['price_after'] !== '' ? intval(str_replace(',', '', $_POST['price_after'])) : null),
    ...
    'mobile_hotspot_unit' => $_POST['mobile_hotspot_unit'] ?? 'GB',
