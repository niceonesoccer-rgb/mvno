...
<head>
    ...
    <script src="assets/js/phone-deal-scroll.js" defer></script>
</head>
<body>
    <header class="header sticky-nav" id="mainHeader">
        <div class="nav-wrapper">
            ...
            <nav class="nav">
                <ul class="nav-list">
                    <li class="nav-item">
                        <a class="nav-link <?php echo (isset($current_page) && $current_page == 'home') ? 'active' : ''; ?>" href="index.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo (isset($current_page) && $current_page == 'plans') ? 'active' : ''; ?>" href="plans.php">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
