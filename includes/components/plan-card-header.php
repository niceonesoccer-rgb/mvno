...
<div class="plan-card-top-header">
    ...
    <div class="plan-badge-favorite-group">
        <button class="plan-favorite-btn-inline" aria-label="찜하기" <?php echo ($layout_type === 'detail') ? 'id="planFavoriteBtn"' : ''; ?>>
        ...
        <?php if ($plan_id > 0): ?>
        <button class="plan-share-btn-inline" aria-label="공유하기" data-share-url="<?php echo htmlspecialchars($share_url); ?>" <?php echo ($layout_type === 'detail') ? 'id="planShareBtn"' : ''; ?>>
