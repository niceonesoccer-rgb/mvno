        ...
        <div class="plans-main-layout">
            ...
            <div class="plans-left-section">
                ...
                <section class="theme-plans-list-section">
                    ...
                    <!-- 기존 요금제 카드 (임시로 주석 처리 - 나중에 제거) -->
                    <!--
                    <div class="plans-list-container">
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32627" class="plan-card-link">
                        ...
                        <!-- 두 번째 요금제 카드 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32632" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <!-- 헤더: 로고, 평점, 배지, 찜 -->
                                        <div class="plan-card-top-header">
                        ...
                        <!-- 세 번째 요금제 카드 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=29290" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <!-- 헤더: 로고, 평점, 배지, 찜 -->
                                        <div class="plan-card-top-header">
                        ...
                        <!-- 네 번째 요금제 카드: 핀다이렉트 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32628" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <div class="plan-card-top-header">
                                            <div class="plan-provider-rating-group">
                        ...
                        <!-- 다섯 번째 요금제 카드: 고고모바일 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32629" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <div class="plan-card-top-header">
                                            <div class="plan-provider-rating-group">
                        ...
                        <!-- 여섯 번째 요금제 카드: 찬스모바일 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32630" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <div class="plan-card-top-header">
                                            <div class="plan-provider-rating-group">
                        ...
                        <!-- 일곱 번째 요금제 카드: 이야기모바일 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32631" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <div class="plan-card-top-header">
                                            <div class="plan-provider-rating-group">
                        ...
                        <!-- 아홉 번째 요금제 카드: 찬스모바일 -->
                        <article class="basic-plan-card">
                            <a href="/MVNO/mvno/mvno-plan-detail.php?id=32633" class="plan-card-link">
                                <div class="plan-card-main-content">
                                    <div class="plan-card-header-body-frame">
                                        <div class="plan-card-top-header">
                                            <div class="plan-provider-rating-group">
