...
(function() {
    ...
    function updateFavoriteIcon(button, isFavorited) {
        ...
        if (isFavorited) {
            ...
            // CSS 스타일도 직접 설정 (중요도 높임)
            iconPath.style.fill = '#ef4444';
            iconPath.style.stroke = 'none';
            iconPath.style.setProperty('fill', '#ef4444', 'important');
            iconPath.style.setProperty('stroke', 'none', 'important');
        } else {
            ...
            // CSS 스타일도 직접 설정
            iconPath.style.fill = '#868E96';
            iconPath.style.stroke = '';
            iconPath.style.setProperty('fill', '#868E96', 'important');
        }
    }
