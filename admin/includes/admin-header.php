    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="<?php echo getAssetPath('/admin/seo/seo-settings.php'); ?>" class="menu-item <?php echo ($currentPage === 'seo-settings.php' || $currentPage === 'category-seo.php' || $currentPage === 'search-engine-verification.php') ? 'active' : ''; ?>">
                    <span class="menu-item-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
